...
public class C7StatsStatic {
    ...
    /**
     * Convert an array of doubles into a comma separated string.
     * @param x input array of doubles
     * @return String
     */
    ...
    /**
     * Sort an array of doubles in increasing value
     * @param x input array of doubles
     * @return String
     */
    public static void selectionSortInc(double[] list) {
    ...
    /**
     * Sort an array of doubles in decreasing value
     * @param x input array of doubles
     * @return String
     */
